...
class RegisterController extends GetxController {
  ...
  Future<void> registerUser(String username, String name, String address,
    ...
    try {
      ...
      Get.snackbar(
          'Error', 'Gagal mendaftarkan pengguna. Silakan coba lagi nanti.',
  ...
  bool validateInputs(
    ...
    if (username.isEmpty ||
        ...
        phoneNumber.isEmpty ||
        password.isEmpty) {
      Get.snackbar('Error', 'Silakan isi semua kolom',
          backgroundColor: Color.fromARGB(255, 0, 0, 0),
          colorText: Color(0xffffffff));
      return false;
    } else if (!isValidEmail(username)) {
      Get.snackbar('Error', 'Silakan masukkan email/username yang valid',
          backgroundColor: Color.fromARGB(255, 0, 0, 0),
          colorText: Color(0xffffffff));
      return false;
